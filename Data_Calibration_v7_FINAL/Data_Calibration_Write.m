...
for i = 1:(length(fileNames)/3) 
    ...
    writematrix(Blood_Cal_BF,strcat(cond,"_Blood_C_Data_NLR_Avg_SD_SEM.txt"));
    writematrix(Plasma_Cal_BF,strcat(cond,"_Plasma_C_Data_NLR_Avg_SD_SEM.txt"));
    writematrix(Bile_Cal_BF,strcat(cond,"_Bile_C_Data_NLR_Avg_SD_SEM.txt"));
    writematrix(Blood_Cal_LF,strcat(cond,"_Blood_C_Data_LR_Avg_SD_SEM.txt"));
    writematrix(Plasma_Cal_LF,strcat(cond,"_Plasma_C_Data_LR_Avg_SD_SEM.txt"));
    writematrix(Bile_Cal_LF,strcat(cond,"_Bile_C_Data_LR_Avg_SD_SEM.txt"));
    ...
    writematrix(Bl_C_BF,strcat(cond,"_Blood_C_Data_NLR_Indiv.txt"));
    writematrix(Pl_C_BF,strcat(cond,"_Plasma_C_Data_NLR_Indiv.txt"));
    writematrix(Bi_C_BF,strcat(cond,"_Bile_C_Data_NLR_Indiv.txt"));
    writematrix(Bl_C_LF,strcat(cond,"_Blood_C_Data_LR_Indiv.txt"));
    writematrix(Pl_C_LF,strcat(cond,"_Plasma_C_Data_LR_Indiv.txt"));
    writematrix(Bi_C_LF,strcat(cond,"_Bile_C_Data_LR_Indiv.txt"));
    ...
    if(exist([cd filesep 'Figures_Calibration'],'file') == 0)
        mkdir('Figures_Calibration') 
    end

    cd Figures_Calibration;

    saveas(figure(i),plotTitle,'tiff');
    ...
    writematrix(Bl_F,strcat(cond,"_Blood_F_Data_Avg_SD_SEM.txt"));
    writematrix(Pl_F,strcat(cond,"_Plasma_F_Data_Avg_SD_SEM.txt"));
    writematrix(Bi_F,strcat(cond,"_Bile_F_Data_Avg_SD_SEM.txt"));
