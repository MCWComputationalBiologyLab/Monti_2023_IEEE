...
for i = 1:(length(filesToPlot)/3 - 1)
    ...
    if mod(i,2) == 0
        %IxxR60
        subplot(3,2,1)
%         errorbar(currBlood(:,1),currBlood(:,2)/10^4,currBlood(:,4)/10^4,colorStr,...
%         'LineWidth',2.0,'MarkerSize',6,'MarkerFaceColor',colorChar,...
%         'MarkerEdgeColor',colorChar,'CapSize',4); hold on;
        axis([0 60 0 1]);
        set(gca,'XTick',(0:10:60),'YTick',(0:0.25:1));
        set(gca,'LineWidth',1.5,'FontSize',18); box off;
        ytickformat('%.1f')
        xlabel('Time (min)'); ylabel(sprintf('Fluorescence x 10^4\n(A.U.)'));
        ...
        subplot(3,2,3)
%         errorbar(currPlasma(:,1),currPlasma(:,2)/10^4,currPlasma(:,4)/10^4,colorStr,...
%         'LineWidth',2.0,'MarkerSize',6,'MarkerFaceColor',colorChar,...
%         'MarkerEdgeColor',colorChar,'CapSize',4); hold on;
        axis([0 60 0 2]);
        set(gca,'XTick',(0:10:60),'YTick',(0:0.5:2));
        set(gca,'LineWidth',1.5,'FontSize',18); box off;
        ytickformat('%.1f')
        xlabel('Time (min)'); ylabel(sprintf('Fluorescence x 10^4\n(A.U.)'));
        ...
        subplot(3,2,5)
%         errorbar(currBile(:,1),currBile(:,2)/10^4,currBile(:,4)/10^4,colorStr,...
%         'LineWidth',2.0,'MarkerSize',6,'MarkerFaceColor',colorChar,...
%         'MarkerEdgeColor',colorChar,'CapSize',4); hold on;
        axis([0 60 0 1.5]);
        set(gca,'XTick',(0:10:60),'YTick',(0:0.5:1.5));
        set(gca,'LineWidth',1.5,'FontSize',18); box off;
        ytickformat('%.1f')
        xlabel('Time (min)'); ylabel(sprintf('Fluorescence x 10^4\n(A.U.)'));
        title(sprintf('Bile'));
...
%         'MarkerEdgeColor',colorChar,'CapSize',4); hold on;
        axis([0 60 0 1.2]);
        set(gca,'XTick',(0:10:60),'YTick',(0:0.3:1.2));
        set(gca,'LineWidth',1.5,'FontSize',18); box off;
        h = gca;
        h.YAxis.Visible = 'off';
        xlabel('Time (min)'); %ylabel(sprintf('Fluorescence x 10^4\n(A.U.)'));
